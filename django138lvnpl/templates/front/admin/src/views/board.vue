		...
		<div :style='{"padding":"0 20px","flex":"auto","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"0","zIndex":"2"}'>
			<div :style='{"width":"25%","padding":"0","flexDirection":"column","display":"flex","gap":"10px"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="usedataChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="usedataChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					<div :style='{"padding":"0 0 0 48px","margin":"0","textAlign":"center","background":"url(http://codegen.caihongy.cn/20250114/a14196a680254a47be040b988fdfa027.png) no-repeat left center","flex":"none","width":"100%","height":"44px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="usedataChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"padding":"0","margin":"0 20px","flexWrap":"wrap","flexDirection":"row","flex":"auto","display":"flex","width":"0"}'>
				...
				<div :style='{"alignContent":"center","padding":"0","margin":"0","color":"#fff","alignItems":"center","background":"none","display":"flex","gap":"12px","width":"100%","fontSize":"14px","justifyContent":"space-evenly","height":"130px"}'>
					...
					<div :style='{"padding":"0","margin":"0","alignItems":"center","background":"none","flexDirection":"column","flex":"1 1 auto","display":"flex","width":"190px","position":"relative","height":"auto","maxWidth":"240px"}'>
						...
						<div :style='{"padding":"0","alignItems":"center","flexDirection":"column","flex":"auto","display":"flex","width":"100%","justifyContent":"center","height":"auto"}'>
							<div :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"inherit","textAlign":"center","width":"100%","lineHeight":"22px","fontSize":"inherit","position":"relative","textOverflow":"ellipsis","height":"22px"}'>使用数据总数</div>
							<div :style='{"lineHeight":"22px","fontSize":"16px","color":"rgba(30, 144, 255, 1)","fontWeight":"bold"}'>{{usedataCount}}</div>
						</div>
					</div>
				</div>
				<div class="echarts6">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="usedataChart6" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts7">
					<div :style='{"padding":"0 0 0 48px","margin":"0","textAlign":"center","background":"url(http://codegen.caihongy.cn/20250114/9ae7fa1ed41a468cb6fc1ee2df8f912c.png) no-repeat left center / auto 100%","flex":"none","width":"100%","height":"50px"}'>
					...
					<el-table id="usedataTable" :data="usedataList" border :stripe="true" :style='{"padding":"0","borderColor":"rgba(92,135,230,.3)","borderWidth":"0","background":"none","width":"100%","overflow-y":"scroll","borderStyle":"solid","height":"calc(100% - 36px)"}'>
						<el-table-column :resizable="true" :sortable="false" prop="userid" label="用户ID"/>
						</el-table-column>
						...
						<el-table-column :resizable="true" :sortable="false" prop="numberoflogins" label="登录次数"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="browsetype" label="浏览内容类型"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="contentpreference" label="内容类别偏好"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="numberoflikes" label="点赞数"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="numberofcomments" label="评论数"/>
						</el-table-column>
					</el-table>
				</div>
				<div class="forecast-box" :style='{"padding":"0 4px","margin":"0","alignItems":"center","flexDirection":"column","display":"flex","transition":"0.3s","justifyContent":"flex-start","flexWrap":"wrap","background":"none","flex":"0 0 auto","gap":"8px","width":"30%","height":"calc(40% - 65px)","order":"5"}'>
					<div :style='{"border":"1px solid #999","padding":"0 10px","margin":"0","borderRadius":"4px","alignItems":"center","display":"flex","width":"100%","order":"2"}'>
						...
						<input :style='{"border":"none","padding":"0 0 0 10px","margin":"0","color":"#fff","background":"none","flex":"auto","width":"0","lineHeight":"24px","height":"24px"}' v-model="forecastForm.numberoflogins" placeholder="请输入登录次数"></input>
					</div>
					<div :style='{"border":"1px solid #999","padding":"0 10px","margin":"0","borderRadius":"4px","alignItems":"center","display":"flex","width":"100%","order":"2"}'>
						<div :style='{"color":"#fff","width":"auto","textAlign":"left"}'>
							点赞数
						</div>
						<input :style='{"border":"none","padding":"0 0 0 10px","margin":"0","color":"#fff","background":"none","flex":"auto","width":"0","lineHeight":"24px","height":"24px"}' v-model="forecastForm.numberoflikes" placeholder="请输入点赞数"></input>
					</div>
					<div :style='{"border":"1px solid #999","padding":"0 10px","margin":"0","borderRadius":"4px","alignItems":"center","display":"flex","width":"100%","order":"2"}'>
						<div :style='{"color":"#fff","width":"auto","textAlign":"left"}'>
							评论数
						</div>
						<input :style='{"border":"none","padding":"0 0 0 10px","margin":"0","color":"#fff","background":"none","flex":"auto","width":"0","lineHeight":"24px","height":"24px"}' v-model="forecastForm.numberofcomments" placeholder="请输入评论数"></input>
					</div>
					<div :style='{"padding":"0 0 0 30px","margin":"0","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250114/a14196a680254a47be040b988fdfa027.png) no-repeat left center","flex":"none","width":"100%","lineHeight":"24px","fontSize":"14px","fontWeight":"600","height":"auto"}'>
						预测年龄：{{form.age}}
					</div>
					<div :style='{"padding":"0 0 0 30px","margin":"0","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250114/a14196a680254a47be040b988fdfa027.png) no-repeat left center","flex":"none","width":"100%","lineHeight":"24px","fontSize":"14px","fontWeight":"600","height":"auto"}'>
						预测浏览内容类型：{{form.browsetype}}
					</div>
			...
			<div :style='{"padding":"0","flexWrap":"wrap","flexDirection":"column","display":"flex","gap":"10px","width":"25%","justifyContent":"space-between"}'>
				<div class="echarts4">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="usedataChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					<div :style='{"padding":"0 0 0 48px","margin":"0","textAlign":"center","background":"url(http://codegen.caihongy.cn/20250114/a14196a680254a47be040b988fdfa027.png) no-repeat left center","flex":"none","width":"100%","height":"44px"}'>
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="usedataChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
		...
		methods:{
				...
				this.$confirm(`是否进行数据预测?`, "提示", {
					...
					this.$http({
						...
						if(res.data&&res.data.code==0){
							...
							this.$http({
								url: 'usedataforecast/forecast',
								method: 'post',
								data: this.forecastForm
							}).then(obj=>{
								if(obj.data&&obj.data.code==0){
									this.$http({
										url: 'usedataforecast/info/' + res.data.data,
										method: 'get'
									}).then(rs2=>{
			...
			getusedataList() {
				...
				this.$http({
					...
					if (data && data.code === 0) {
						this.usedataList = data.data.list;
						let div = document.getElementById('usedataTable')
						var scrollTop = -1
						function move() {
							if (div){
						...
						this.usedataTimer = setInterval(move, 2000);
						div.addEventListener('mouseenter', e => {
							e.stopPropagation()
							clearInterval(this.usedataTimer);
						})
			...
			usedataChat1() {
				this.$nextTick(()=>{
					...
					var usedataChart1 = echarts.init(document.getElementById("usedataChart1"),'macarons');
					this.$http({
						url: `usedata/value/userid/numberoflikes`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							usedataChart1.setOption(option);
				
							this.myChartInterval(1, option.xAxis.data, option.series[0].data, usedataChart1)

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								usedataChart1.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			usedataChat2() {
				this.$nextTick(()=>{
					...
					var usedataChart2 = echarts.init(document.getElementById("usedataChart2"),'macarons');
					this.$http({
						url: `usedata/value/userid/numberofcomments`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							usedataChart2.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								usedataChart2.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			usedataChat3() {
				this.$nextTick(()=>{
					...
					var usedataChart3 = echarts.init(document.getElementById("usedataChart3"),'macarons');
					this.$http({
						url: `usedata/value/userid/numberofshares`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							usedataChart3.setOption(option);
				
							this.myChartInterval(2, option.yAxis.data, option.series[0].data, usedataChart3)

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								usedataChart3.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			usedataChat4() {
				this.$nextTick(()=>{
					...
					var usedataChart4 = echarts.init(document.getElementById("usedataChart4"),'macarons');
					this.$http({
						url: `usedata/value/userid/numberofvideos`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							usedataChart4.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								usedataChart4.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			usedataChat5() {
				this.$nextTick(()=>{
					...
					var usedataChart5 = echarts.init(document.getElementById("usedataChart5"),'macarons');
					this.$http({
						url: `usedata/value/userid/numberoflogins`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							usedataChart5.setOption(option);

							this.myChartInterval(1, option.xAxis.data, option.series[0].data, usedataChart5)

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								usedataChart5.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			usedataChat6() {
				this.$nextTick(()=>{
					...
					var usedataChart6 = echarts.init(document.getElementById("usedataChart6"),'macarons');
					this.$http({
						url: "usedata/group/age",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							// 使用刚指定的配置项和数据显示图表。
							usedataChart6.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								usedataChart6.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
